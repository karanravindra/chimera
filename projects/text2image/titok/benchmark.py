...
Examples
--------
    uv run python projects/text2image/titok/benchmark.py --image-size 128 --batch-size 16 \
        --num-workers 4 --compile off --steps 30 --warmup 8
    uv run python projects/text2image/titok/benchmark.py --compile reduce-overhead --steps 40
"""
